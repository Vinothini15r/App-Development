  ...
  useEffect(() => {
    const getProducts = async () => {
      ...
      try {
        ...
        headers: {
            'Authorization':"Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhYWFAZ21haWwuY29tIiwiaWF0IjoxNjk2NTY5Njc1LCJleHAiOjE2OTY2NTYwNzV9.vj2Tx-oudMmFq6wGQJ5eC_VdBRWZuM_krLrffRGxH1E",
